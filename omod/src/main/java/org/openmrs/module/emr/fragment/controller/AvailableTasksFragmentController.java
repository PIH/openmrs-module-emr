...
public class AvailableTasksFragmentController {

    public void controller(EmrContext emrContext, PageModel model, @SpringBean("taskService") TaskService taskService) {
