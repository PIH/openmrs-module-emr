...
/**
 * Subclasses represent tasks (that requires a patient to be in the context to be enabled) for entering an HTML Form.
 *
 ...
 */
public abstract class BaseEnterPatientHtmlFormTask extends BasePatientSpecificTaskDescriptor {

    @Autowired
    @Qualifier("uiUtils")
    protected UiUtils uiUtils;

    protected EntryTiming timing = EntryTiming.REAL_TIME;
    ...
    public void setHtmlFormId(Integer htmlFormId) {
