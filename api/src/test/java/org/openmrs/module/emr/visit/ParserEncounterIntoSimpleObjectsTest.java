...
public class ParserEncounterIntoSimpleObjectsTest {
    ...
    public void testParsingDiagnoses() throws Exception {
        ...
        assertThat(path(parsed.getDiagnoses(), 0, "answer"), is((Object) "(emr.Diagnosis.Certainty.PRESUMED) Random Disease"));
    ...
    public void testParsingSimpleObs() throws Exception {
        ...
        Concept consultComments = new ConceptBuilder(conceptService, textDatatype, misc)
                .addName(consultNote).get();
