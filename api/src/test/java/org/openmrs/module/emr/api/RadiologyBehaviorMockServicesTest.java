...
import org.openmrs.module.emr.api.impl.RadiologyServiceImpl;
...
public class RadiologyBehaviorMockServicesTest {
	...
	public void beforeEachTest() {
		...
		service = new RadiologyServiceImpl();
	}
    ...
    class MockOrderService extends OrderServiceImpl {
    	...
    	/**
    	 * @see org.openmrs.api.impl.OrderServiceImpl#getOrderTypeByUuid(String)
    	 */
        @Override
    ...
    class MockConceptService extends ConceptServiceImpl {
    	...
    	/**
    	 * @see org.openmrs.api.impl.ConceptServiceImpl#getConceptByUuid(String)
    	 */
    	@Override
    ...
    class MockAdministrationService extends AdministrationServiceImpl {
    	...
    	public MockAdministrationService() {
    		...
    		db.put(EMRConstants.RADIOLOGY_ORDERABLE_CONCEPTS_GP, "cxr-uuid,ct-scan-uuid");
    		db.put(EMRConstants.RADIOLOGY_ORDERTYPE_GP, "radiology-order-type-uuid");
    	}

    	/**
    	 * @see org.openmrs.api.impl.AdministrationServiceImpl#getGlobalProperty(String)
    	 */
    	@Override
