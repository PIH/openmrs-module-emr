...
public class BasicDimensionLibraryTest {
    ...
    public void setUp() throws Exception {
        CohortDefinitionService cohortDefinitionService = mock(CohortDefinitionService.class);
        when(cohortDefinitionService.getDefinitionByUuid(anyString())).thenReturn(new GenderCohortDefinition());

        library = new BasicDimensionLibrary(cohortDefinitionService);
    }
