...
public class RadiologyBehaviorMockitoWithUtilsTest {
	...
	public void beforeEachTest() {
		...
		addMockGlobalProperty(mockAdminService, EMRConstants.RADIOLOGY_ORDERABLE_CONCEPTS_GP, "cxr-uuid,ct-scan-uuid");
		addMockGlobalProperty(mockAdminService, EMRConstants.RADIOLOGY_ORDERTYPE_GP, "radiology-order-type-uuid");
