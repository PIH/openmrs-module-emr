...
public class EmrConceptServiceComponentTest extends BaseModuleContextSensitiveTest {
    ...
    public void testGetConceptsSameOrNarrowerThanTerm() throws Exception {
        ...
        ConceptMapType sameAs = conceptService.getConceptMapTypeByUuid(EmrConstants.SAME_AS_CONCEPT_MAP_TYPE_UUID);
        ConceptMapType narrowerThan = conceptService.getConceptMapTypeByUuid(EmrConstants.NARROWER_THAN_CONCEPT_MAP_TYPE_UUID);
