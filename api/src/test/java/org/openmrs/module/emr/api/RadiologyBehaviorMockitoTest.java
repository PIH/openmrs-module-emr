...
public class RadiologyBehaviorMockitoTest {
    ...
    public void beforeEachTest() {
        ...
        when(mockAdminService.getGlobalProperty(EMRConstants.RADIOLOGY_ORDERABLE_CONCEPTS_GP)).thenReturn("cxr-uuid,ct-scan-uuid");
        when(mockAdminService.getGlobalProperty(EMRConstants.RADIOLOGY_ORDERTYPE_GP)).thenReturn("radiology-order-type-uuid");
