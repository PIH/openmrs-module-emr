...
public class RadiologyBehaviorContextSensitiveTest extends BaseModuleContextSensitiveTest {

    RadiologyService service;
	
    @Before
	public void beforeEachTest() {
		service = Context.getService(RadiologyService.class);
		Context.getAdministrationService().saveGlobalProperty(new GlobalProperty(EMRConstants.RADIOLOGY_ORDERABLE_CONCEPTS_GP, "c607c80f-1ea9-4da3-bb88-6276ce8868dd,a09ab2c5-878e-4905-b25d-5784167d0216"));
		Context.getAdministrationService().saveGlobalProperty(new GlobalProperty(EMRConstants.RADIOLOGY_ORDERTYPE_GP, "e23733ab-787e-4096-8ba2-577a902d2c2b"));
	}
